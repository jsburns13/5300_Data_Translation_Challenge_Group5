...
We also want to look at the employment variation as % changes to capture normalized changes across groups.
The following is still total % change over time but this shows a more normalized feature. 
...
# Drop in Employment by marital status
agg <- df %>% 
